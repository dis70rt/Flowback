...
import { SmsAppMockup, WhatsAppAppMockup, EmailAppMockup, CallAppMockup } from '@/components/mockups';
        ...
        {pendingAction ? (
          <>
            <div className="w-full max-w-[380px] flex flex-col mb-4 gap-1 shrink-0">
              <div className="text-[10px] uppercase tracking-widest text-slate-500 font-semibold">{pendingAction?.channel?.String === 'send_sms' ? 'SMS / iMessage' : pendingAction?.channel?.String === 'send_email' ? 'Email (Gmail)' : pendingAction?.channel?.String === 'send_call' ? 'Phone Call' : 'WhatsApp'}</div>
            ...
            <div className="relative w-full max-w-[380px] flex-1 min-h-[500px] my-4">
              ...
              >
                ...
                >
                  ...
                  ) : pendingAction?.channel?.String === "send_call" ? (
                    <CallAppMockup customer={customer} pendingAction={pendingAction} />
                  ) : (
